...
export default function NewVisitorSignup() {
  ...
  return (
    <aside
      ...
      aria-label="Belfiore account sign-up invitation"
      aria-live="polite"
    >
      <button
        type="button"
        ...
        onClick={closePromo}
        aria-label="Close sign-up invitation"
      >
      ...
      <div>
        ...
        <h2 className="font-serif text-[1.35rem] leading-tight text-[#173d2b]">Make plant shopping easier</h2>
        <p className="mt-2 mb-3.5 max-w-68 text-sm leading-6 text-[#526158]">Create an account to track orders and check out faster. Free shipping applies to orders over ₱2,000.</p>
        <Link
          to="/signup"
